...
class Agent:
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size, epsilon_end=0.01, mem_size=100000, fname='./models/dueling_dqn/saved/weights/', linear=False, replace_target=1000):
